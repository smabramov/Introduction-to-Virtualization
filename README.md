...
3. Windows-системы для использования бухгалтерским отделом -можно использовать виртуализацию уровня ОС, этот метод поддерживает единственную операционную систему. А так физические сервера, помоему связанно с законодательством РФ.
